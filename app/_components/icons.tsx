...
export function ChefHatIcon({ className = "h-5 w-5" }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M6 17a4 4 0 0 1-1-7.8 5 5 0 0 1 9.8-1.6A4.5 4.5 0 0 1 19 9.2 4 4 0 0 1 18 17" />
    </svg>
  );
}
...
export function HomeIcon({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M3 11.5 12 4l9 7.5V20a1.5 1.5 0 0 1-1.5 1.5h-4V15h-7v6.5h-4A1.5 1.5 0 0 1 3 20z" />
    </svg>
  );
}

export function OrdersIcon({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function MenuItemsIcon({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function IngredientsIcon({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
      ...
      aria-hidden
    >
      <path d="M11 3a7 7 0 0 1 7 7c0 4-3 8-7 11-4-3-7-7-7-11a7 7 0 0 1 7-7z" />
      <path d="M11 3c2 3 2 6 0 9" />
    </svg>
  );
}

export function InventoryIcon({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function GroceryListsIcon({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
      ...
      aria-hidden
    >
      <path d="M5 7a2 2 0 0 1 2-2h2l1-2h4l1 2h2a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2z" />
...
export function ClientsIcon({ className = "h-4 w-4" }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M14.5 14.8c2 .2 4 1.6 4.5 4.2" />
    </svg>
  );
}

export function AnalyticsIcon({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function HelpIcon({ className = "h-4 w-4" }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M9.5 9a2.5 2.5 0 1 1 3.5 2.3c-.7.3-1 .8-1 1.5V13" />
      <path d="M12 17h.01" />
    </svg>
  );
}
...
export function ScaleIcon({ className = "h-4 w-4" }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M3 9h6l-3 6-3-6z" />
      <path d="M15 9h6l-3 6-3-6z" />
      <path d="M6 4h12" />
    </svg>
  );
}
...
export function CartIcon({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M3 4h2l2.5 12.5a2 2 0 0 0 2 1.5h7.5a2 2 0 0 0 2-1.5L21 8H6.5" />
...
export function SortIcon({ className = "h-4 w-4" }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M16 20V4M20 16l-4 4-4-4" />
    </svg>
  );
}
...
export function SparklesIcon({ className = "h-4 w-4" }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M18.5 14.5 19.2 16.5 21.2 17.2 19.2 17.9 18.5 19.9 17.8 17.9 15.8 17.2 17.8 16.5z" />
      <path d="M5 16.5 5.6 17.9 7 18.5 5.6 19.1 5 20.5 4.4 19.1 3 18.5 4.4 17.9z" />
    </svg>
  );
}
...
export function UsersIcon({ className = "h-4 w-4" }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M3 20c.7-3.5 3-5.5 6-5.5s5.3 2 6 5.5" />
      <circle cx="17" cy="10" r="2.5" />
      <path d="M16 14.5c2.5.3 4.5 2.3 5 5.5" />
    </svg>
  );
}
